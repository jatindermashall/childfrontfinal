        ...
        <div class="companies">
            ...
            <div class="row">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="company-content">
                  <h3>Jagan Singh<span class="full-time">Full Time</span></h3>
                  <p>
                    <span class="company-name"
                      ><i class="fa fa-briefcase"></i>Google</span
                    ><span class="company-location"
                      ><i class="fa fa-map-marker"></i> 07th Avenue, New York,
                      NY, United States</span
                    ><span class="package"
                      ><i class="fa fa-money"></i>$22,000-$50,000</span
                    >
                  </p>
                </div>
              </div>
          ...
          <div class="company-list">
            <div class="row">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="company-content">
                  <h3>Vishvas<span class="part-time">Part Time</span></h3>
                  <p>
                    <span class="company-name"
                      ><i class="fa fa-briefcase"></i>Microsoft</span
                    ><span class="company-location"
                      ><i class="fa fa-map-marker"></i> 7th Avenue, New York,
                      NY, United States</span
                    ><span class="package"
                      ><i class="fa fa-money"></i>$20,000-$52,000</span
                    >
                  </p>
                </div>
              </div>
          ...
          <div class="company-list">
            <div class="row">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="company-content">
                  <h3>Daniel<span class="freelance">Freelance</span></h3>
                  <p>
                    <span class="company-name"
                      ><i class="fa fa-briefcase"></i>Apple</span
                    ><span class="company-location"
                      ><i class="fa fa-map-marker"></i> 7th Avenue, New York,
                      NY, United States</span
                    ><span class="package"
          ...
          <div class="company-list">
            <div class="row">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="company-content">
                  <h3>Ricky<span class="internship">Intership</span></h3>
                  <p>
                    <span class="company-name"
                      ><i class="fa fa-briefcase"></i>Wipro</span
                    ><span class="company-location"
                      ><i class="fa fa-map-marker"></i> 8th Avenue, New York,
                      NY, United States</span
                    ><span class="package"
                      ><i class="fa fa-money"></i>$24,000-$52,000</span
                    >
                  </p>
                </div>
              </div>
          ...
          <div class="company-list">
            <div class="row">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="company-content">
                  <h3>Yousuf<span class="full-time">Full Time</span></h3>
                  <p>
                    <span class="company-name"
                      ><i class="fa fa-briefcase"></i>Twitter</span
                    ><span class="company-location"
                      ><i class="fa fa-map-marker"></i> 4th Avenue, New York,
                      NY, United States</span
                    ><span class="package"
                      ><i class="fa fa-money"></i>$24,000-$48,000</span
                    >
                  </p>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1">
            <h2>Want More Names & Latest Trends?</h2>
            <p>
